...
public class FieldCentric extends OpMode {
    ...
    public void loop() {
        ...
        if(gamepad1.b) foundation_mover.setPosition(0 * gp2_percent_pwr);
        ...
        if(gamepad2.left_bumper)       collector_arm.setPosition(0.7 * gp2_percent_pwr);
        else if(gamepad2.right_bumper) collector_arm.setPosition(0.403 * gp2_percent_pwr);
