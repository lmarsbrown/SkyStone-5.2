...
@Autonomous(name="2 Stone Red", group="Iterative Opmode")
//@Disabled
public class VuforiaTestDriveRedTwoStones extends OpMode {
                ...
                control.gotoPoint(new Transform(stoneAPos.x,stoneAPos.y+200,0),true,true,0.7,0.000008,(Object o)->{
                    control.gotoPoint(new Transform(stoneAPos.x,stoneAPos.y,0),true,true,0.35,0.000008,(Object op)-> {
                        ...
                        control.gotoPoint(new Transform(rowboat.pos.x, -620, Math.PI * 0.5), true, true, 0.7, 0.00003, (Object yyyyyyyyy) -> {
                            control.gotoPoint(new Transform(1333, -620, Math.PI * 0.5), true, false, 0.7, 0.00003, (Object acbmgfdhjkilmnozqrtwrvwyxzed) -> {
                                collector_arm.setPosition(0.72);
                                control.gotoPoint(new Transform(Math.max(stoneAPos.x - 600, -690), -500, 0), true, true, 0.7, 0.00003, (Object sgerhgseg) -> {
                                    control.gotoPoint(new Transform(Math.max(stoneAPos.x - 600, -690), -760, 0), true, true, 0.35, 0, (Object irewgrw) -> {
                                        collector_arm.setPosition(0.403);
                                        inner_collector.setPower(-0.7);
                                        outer_collector.setPower(-0.7);
                                        try {
                                        ...
                                        inner_collector.setPower(0);
                                        outer_collector.setPower(0);
                                        control.gotoPoint(new Transform(Math.max(stoneAPos.x - 600, -690),-630,Math.PI*0.5),true,true,0.7,0,(Object onocompetiontomorrowihavetogohomeat7no)->{
                                            control.gotoPoint(new Transform(1333,-620,Math.PI*0.5),true,true,0.7,0,(Object togohomeat)->{
                                                collector_arm.setPosition(0.72);
                                                control.gotoPoint(new Transform(800,-620,Math.PI*0.5),true,false,0.7,0,(Object meat)->{
                                                    return 0;
                                                });
                                                return 0;
                                            });
